...
class KuGouAudioSourceResolverTest {
    @Test fun asksForPreviewOnlyAfterDenialAndKeepsAuthenticationOutOfUrl() = runBlocking {
        MockWebServer().use { server ->
            ...
            server.enqueue(MockResponse().setHeader("Content-Type", "application/json")
                .setBody("""{"status":1,"url":["https://audio.example.invalid/clip.mp3"],"hash_offset":{"clip_hash":"synthetic","start_ms":65700,"end_ms":125700}}"""))
            ...
            assertEquals(65_700L, source.previewStartMs)
